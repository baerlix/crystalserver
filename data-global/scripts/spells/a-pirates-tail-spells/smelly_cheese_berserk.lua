...
-- Callback para manejar el daño en "Rum Barrel" o jugadores
...
-- Callback para ejecutar spellCallbackCheeseBerserk en cada posición del área
...
function spell.onCastSpell(creature, var)
	-- Ejecutar el primer efecto (CONST_ME_HITBYPOISON)
	addEvent(runSpell, 500, creature:getId(), combat, var)
	-- Ejecutar el segundo efecto (CONST_ME_POISONAREA)
